...
// PdfHaruTest.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPdfHaruTestApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CPdfHaruTestApp

CPdfHaruTestApp::CPdfHaruTestApp()
{
...
// Единственный объект CPdfHaruTestApp

CPdfHaruTestApp theApp;


// инициализация CPdfHaruTestApp

BOOL CPdfHaruTestApp::InitInstance()
{
